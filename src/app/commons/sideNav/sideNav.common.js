      ...
      <AnimatedBlock
        ...
        <AnimatedBlock
          ...
          <AnimatedBlock
            ...
            style={{
              width: bInterpolate(expandAnimation.value, [60, 80]),
            }}>
        ...
        {getNavGroup(routes["Sample"])}
        {getNavGroup(routes["Building"])}
        {getNavGroup(routes["Demo"])}
        {getNavGroup(routes["Demo Generic"])}
      </AnimatedBlock>
    </div>
  );
};
